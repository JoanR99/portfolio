			...
			<div className="mx-auto max-w-sm  px-4 sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
				<div className="min-h-screen pt-24">
					...
					<p className="text-md mt-4">
						...
						autenticación básico basado JWT, y con internacionalización (ingles
						y español).
					</p>
					...
					<div className="my-8 grid w-full grid-cols-1 lg:mt-10 lg:grid-cols-2 lg:items-center lg:gap-x-10">
						...
						<div className="my-8 h-fit lg:col-span-2 lg:mb-4">
							...
							<p className="text-md mt-2">
								...
								autenticación, filtrado por color y búsqueda, ademas de añadir
						...
						<div className="mt-8 flex h-fit flex-col">
							<div>
								...
								<p className="text-md mt-2">
									...
									utilidades de librerías de terceros y aprendí a implementar
									internacionalización, sumado a toda la experiencia que obtuve
									con TypeScript.
								</p>
							</div>
						</div>
